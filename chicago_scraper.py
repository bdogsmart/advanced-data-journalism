...
def get_html(ward):
    ...
    You should place the resulting HTML in a variable called html.
    '''
    ...
    url = "http://www.chicagoelections.com/en/pctlevel3.asp" + "?Ward=%s&elec_code=%s&race_number=%s" % (ward, elec_code, race_number)
